...
"use strict";
__webpack_require__.r(__webpack_exports__);
function NoneMain(main, data) {
  this.init = function () {};
}

/* harmony default export */ __webpack_exports__["default"] = (NoneMain);
...
function Responsive(game, resizeCallback, postResizeCallback) {
  ...
  this.resizeNow = function () {}; //var type = window.app && window.app.type && null;
